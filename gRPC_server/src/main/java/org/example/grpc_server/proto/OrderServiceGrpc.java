...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.grpc_server.proto.OrderRequest,
      org.example.grpc_server.proto.OrderResponse> getGetOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetOrder",
      requestType = org.example.grpc_server.proto.OrderRequest.class,
      responseType = org.example.grpc_server.proto.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.grpc_server.proto.OrderRequest,
      org.example.grpc_server.proto.OrderResponse> getGetOrderMethod() {
    io.grpc.MethodDescriptor<org.example.grpc_server.proto.OrderRequest, org.example.grpc_server.proto.OrderResponse> getGetOrderMethod;
    if ((getGetOrderMethod = OrderServiceGrpc.getGetOrderMethod) == null) {
      synchronized (OrderServiceGrpc.class) {
        if ((getGetOrderMethod = OrderServiceGrpc.getGetOrderMethod) == null) {
          OrderServiceGrpc.getGetOrderMethod = getGetOrderMethod =
              io.grpc.MethodDescriptor.<org.example.grpc_server.proto.OrderRequest, org.example.grpc_server.proto.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc_server.proto.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc_server.proto.OrderResponse.getDefaultInstance()))
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getOrder(org.example.grpc_server.proto.OrderRequest request,
        io.grpc.stub.StreamObserver<org.example.grpc_server.proto.OrderResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                org.example.grpc_server.proto.OrderRequest,
                org.example.grpc_server.proto.OrderResponse>(
  ...
  public static final class OrderServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<OrderServiceBlockingStub> {
    ...
    /**
     */
    public org.example.grpc_server.proto.OrderResponse getOrder(org.example.grpc_server.proto.OrderRequest request) {
  ...
  public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractFutureStub<OrderServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.grpc_server.proto.OrderResponse> getOrder(
        org.example.grpc_server.proto.OrderRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ORDER:
          serviceImpl.getOrder((org.example.grpc_server.proto.OrderRequest) request,
              (io.grpc.stub.StreamObserver<org.example.grpc_server.proto.OrderResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.grpc_server.proto.Order.getDescriptor();
    }
